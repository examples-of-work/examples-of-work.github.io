...
function myFunction(){if(window.navigator.msPointerEnabled)for(var e=document.querySelectorAll(".button_buy"),i=0;i<e.length;i++)e[i].onclick=function(){document.querySelector("html").style.marginRight="0px"};else if(/Edge/.test(navigator.userAgent))for(e=document.querySelectorAll(".button_buy"),i=0;i<e.length;i++)e[i].onclick=function(){document.querySelector("html").style.marginRight="0px"}}$(window).on("load",function(){$preloader=$(".loaderArea"),$loader=$preloader.find(".loader"),$loader.fadeOut(),$preloader.delay(350).fadeOut("slow")}),$(".toggle").click(function(){$(this).toggleClass("on"),$("#menu_big").slideToggle()}),$(function(){$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black","position-back","position-right"],navbar:{title:'<img src="img/logo.png" alt="">'},offCanvas:{pageSelector:"#my-page"}});var e=$("#my-menu").data("mmenu");e.bind("open:start",function(){$(".hamburger").addClass("is-active")}),e.bind("close:before",function(){$(".hamburger").removeClass("is-active")})}),$(function(){$(".multiple-items").slick({infinite:!0,dots:!1,slidesToShow:5,slidesToScroll:1,prevArrow:"<i class='fa fa-angle-left prev' aria-hidden='true'></i>",nextArrow:"<i class='fa fa-angle-right next' aria-hidden='true'></i>",responsive:[{breakpoint:1200,settings:{slidesToShow:3}},{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:768,settings:{slidesToShow:1}}]})}),$(".button_buy").magnificPopup({type:"inline",midClick:!0}),myFunction();
